...
public class UserServiceImpl implements UserService {
	...
	@Override
	public UserPublicInfoVO getMyUserProfileInfo(@NotNull final String uuid) {
		...
		userPublicInfoVO.setVipId(
				(vipDO != null && vipDO.getVuuid() != null) ? vipDO.getVuuid() : "");
		//  设置用户角色名称与id
		SqlRoleDO roleDO = roleDAO.getRoleByRUUID(userDO.getRole());
		userPublicInfoVO.setRoleName((roleDO != null && roleDO.getDisplayName()
				!= null) ? roleDO.getDisplayName() : "");
