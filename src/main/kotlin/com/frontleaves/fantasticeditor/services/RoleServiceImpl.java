...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public boolean editCustomRole(@NotNull final RoleCustomEditVO roleCustomEditVO, @NotNull final String roleId) {
        ...
        if (getRole != null) {
            ...
            // 更新角色信息
            getRole.setName(roleCustomEditVO.getName()).setDisplayName(roleCustomEditVO.getDisplayName())
    ...
    public boolean addRole(@NotNull final RoleCustomEditVO roleCustomEditVO) {
        ...
        SqlRoleDO newRole = new SqlRoleDO().setRuuid(Util.INSTANCE.makeNoDashUUID()).setName(roleCustomEditVO.getName())
            .setDisplayName(roleCustomEditVO.getDisplayName()).setDescription(roleCustomEditVO.getDescription())
            .setUpdatedAt(new Timestamp(System.currentTimeMillis()))
            .setPermissions(gson.toJson(roleCustomEditVO.getPermissions()));
    ...
    @Override
    public List<RoleInfoVO> getUserRoleInfo(@NotNull final List<String> uuids, @NotNull final List<String> usernames,
        @NotNull final List<String> ruuids, @NotNull final List<String> roleNames) {
    ...
    private final String roleTypeName = "roleName";
    private final String roleTypeId = "ruuid";
    ...
    private RoleInfoVO encapsulateRoleByIdOrName(final String data, final String type) {
        ...
        if (roleTypeName.equals(type)) {
            sqlRoleDO = roleDAO.getRoleByRUUID(data);
        } else if (roleTypeId.equals(type)) {
